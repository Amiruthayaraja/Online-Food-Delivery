              ...
              {tab === 'desc' ? (
                ...
                <div className='tab__form mb-3'>
                  <div className='review pt-5'>
                    <p className='user__name mb-0'>Jazeer</p>
                    <p className='user__email'>jzeer2hussain@gmail.com</p>
                    <p className='feedback__text'>Great food</p>
                  </div>

                  <div className='review'>
                    <p className='user__name mb-0'>Vallal</p>
                    <p className='user__email'>vallal@gmail.com</p>
